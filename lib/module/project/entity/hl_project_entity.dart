...
class HLProjectEntity extends HLDbBaseEntity {
  int? id;
  String? title;
  String? desc;
  String? shareUser;
  ...
  factory HLProjectEntity.fromJson(Map<String, dynamic> json) => HLProjectEntity(
    id: json['id'],
    title: json['title'],
    desc: json['desc'],
  ...
  @override
  HLDbBaseEntity fromMap(Map<String, dynamic> map) => HLProjectEntity(
    id: map['id'],
    title: map['title'],
    desc: map['desc'],
