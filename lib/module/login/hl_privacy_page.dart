...
class HLPrivacyPage extends StatefulWidget {
  HLPrivacyPage({Key? key}) : super(key: key);

  @override
  _HLPrivacyPageState createState() => _HLPrivacyPageState();
}

class _HLPrivacyPageState extends State<HLPrivacyPage> {
