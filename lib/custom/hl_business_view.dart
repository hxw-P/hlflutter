...
class HLBusinessView {
              ...
              children: [
                ...
                GestureDetector(
                  child: Container(
                    ...
                    height: Util.px(30),
                    child: Obx(() => article.collect.value == true
                        ? Image.asset("images/home/list_collect_sel.png")
              ...
              children: [
                ...
                article.envelopePic!.isNotEmpty
                  ...
                  children: [
                    Container(
                      padding:
                      EdgeInsets.fromLTRB(Util.px(5), 0, 0, 0),
                      width: Util.px(50),
  ...
  static commonRow(
      ...
      String iconPath, {
        ...
        EdgeInsetsGeometry? marign, // 支持自定义位置
        bool hasArrow = true, // 是否有箭头，默认有
        double circular = 0, // 圆角
        bool isTopFirst = false, // 是否是顶部第一个cell，需要多留空间
        bool isLoaclImage = true, // 是否显示本地图片
        bool hasCheck = false, // 是否有打勾，默认无
      }) {
    return GestureDetector(
      child: Container(
        //超出部分，可裁剪
          ...
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(circular), color: color),
          margin: marign ??
              EdgeInsets.fromLTRB(
                  Util.px(10),
                  isTopFirst == true ? Util.px(10) : Util.px(5),
                  Util.px(10),
                  Util.px(5)),
            ...
            children: [
              Row(
                ...
                children: [
                  Container(
                      padding: EdgeInsets.fromLTRB(
                          iconPath.isNotEmpty ? Util.px(10) : 0, 0, 0, 0),
                      height: height == 0
                          ? Util.px(40) - Util.px(1)
                          : height - Util.px(1),
                  ...
                  Expanded(
                    child: Container(
                      margin: EdgeInsets.fromLTRB(
                          imgRightGap == 0 ? Util.px(10) : imgRightGap,
                          0,
                          0,
                          0),
                  ...
                  hasArrow == true
                      ? Image.asset('images/common/arrow.png',
                      width: Util.px(20), height: Util.px(20))
                      : Container(),
                  hasCheck == true
                      ? GestureDetector(
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0, height == 0 ? (Util.px(39) - Util.px(20))/2 : (height - Util.px(20))/2, Util.px(10), height == 0 ? (Util.px(39) - Util.px(20))/2 : (height - Util.px(20))/2),
                      child: Image.asset('images/common/check.png',
                          width: Util.px(20), height: Util.px(20)),
                    ),
                  )
                      : Container(),
  ...
  /// 用户头像
  static personalHeader(HLUserEntity userInfo, AppTheme appTheme, Function actionBlock) {
    return Container(
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(Util.px(4)),
          color: appTheme.themeColor),
      margin:
      EdgeInsets.fromLTRB(Util.px(10), Util.px(5), Util.px(10), Util.px(5)),
    ...
    userInfo.userName!.isEmpty
              ? GestureDetector(
            child: Container(
              margin: EdgeInsets.fromLTRB(0, Util.px(10 + 30), 0, 0),
              padding: EdgeInsets.fromLTRB(Util.px(10), Util.px(10), Util.px(10), Util.px(10)),
              child: Text(HLLocal.clickLogin.tr),
            ),
            onTap: () {
              if (actionBlock != null) {
                actionBlock();
